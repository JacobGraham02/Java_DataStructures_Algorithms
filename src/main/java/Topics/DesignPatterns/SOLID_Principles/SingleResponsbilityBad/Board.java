package Topics.DesignPatterns.SOLID_Principles.SingleResponsbilityBad;

import java.util.ArrayList;

// This Board class violates the single responsibility principle because it is concerned with displaying the board, calculating the board values, and displaying the board.
